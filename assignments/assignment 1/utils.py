...
def get_density_map_gaussian(im, points, adaptive_mode=False, fixed_value=15, fixed_values=None):
    ...
    for idx, p in enumerate(points):
        ...
        # otherwise 'ValueError: operands could not be broadcast together with shapes (91,397) (91,0) (91,397)'
        if p[0] < 0 or p[1] < 0:
            continue
        ...
        # print(gaussian_map.shape, p[1]+gaussian_radius+1, p[1], gaussian_radius)
